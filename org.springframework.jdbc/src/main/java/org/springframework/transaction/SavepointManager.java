...
public interface SavepointManager {
	 ...
	 * @throws org.springframework.transaction.TransactionException if the savepoint could not be created,
	 ...
	 * @throws NestedTransactionNotSupportedException if the underlying
	 * transaction does not support savepoints
	 * @throws org.springframework.transaction.TransactionException if the rollback failed
	 ...
	 * @throws NestedTransactionNotSupportedException if the underlying
	 * transaction does not support savepoints
	 * @throws org.springframework.transaction.TransactionException if the release failed
